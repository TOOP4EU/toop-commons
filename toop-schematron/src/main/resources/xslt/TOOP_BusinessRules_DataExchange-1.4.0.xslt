...
<xsl:if test="exists(toop:DataRequestIdentifier)">
      <svrl:successful-report test="exists(toop:DataRequestIdentifier)">
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="matches(//toop:RoutingInformation//toop:DocumentTypeIdentifier/text(),'urn:eu:toop:ns:dataexchange-1p40::Request##urn:eu.toop.request.registeredorganization::1.40')" />
      <xsl:otherwise>
        <svrl:failed-assert test="matches(//toop:RoutingInformation//toop:DocumentTypeIdentifier/text(),'urn:eu:toop:ns:dataexchange-1p40::Request##urn:eu.toop.request.registeredorganization::1.40')">
          ...
          <svrl:text>
                A Request DocumentTypeIdentifier must be 'urn:eu:toop:ns:dataexchange-1p40::Request##urn:eu.toop.request.registeredorganization::1.40'.
            </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="matches(toop:RoutingInformation//toop:DocumentTypeIdentifier/text(),'urn:eu:toop:ns:dataexchange-1p40::Response##urn:eu.toop.response.registeredorganization::1.40')" />
      <xsl:otherwise>
        <svrl:failed-assert test="matches(toop:RoutingInformation//toop:DocumentTypeIdentifier/text(),'urn:eu:toop:ns:dataexchange-1p40::Response##urn:eu.toop.response.registeredorganization::1.40')">
          ...
          <svrl:text>
                A Response DocumentTypeIdentifier must be 'urn:eu:toop:ns:dataexchange-1p40::Response##urn:eu.toop.response.registeredorganization::1.40'.
            </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:template match="toop:DCLegalAddress//toop:CountryCode | toop:DPLegalAddress//toop:CountryCode | toop:RoutingInformation//toop:CountryCode" mode="M26" priority="1002">
...
<xsl:template match="toop:NaturalPersonLegalAddress//toop:CountryCode | toop:LegalPersonLegalAddress//toop:CountryCode" mode="M26" priority="1001">
...
<xsl:template match="toop:LegalPersonUniqueIdentifier | toop:PersonIdentifier" mode="M26" priority="1000">
...
<xsl:template match="toop:DataRequestSubjectTypeCode" mode="M27" priority="1000">
...
<xsl:template match="toop:GenderCode" mode="M28" priority="1000">
...
<xsl:template match="toop:ConceptTypeCode" mode="M29" priority="1000">
...
<xsl:template match="toop:ResponseAmount" mode="M30" priority="1000">
...
<xsl:template match="toop:StandardIndustrialClassification" mode="M31" priority="1000">
...
<xsl:template match="toop:DataElementResponseValue//toop:ErrorCode" mode="M32" priority="1000">
...
<xsl:template match="toop:DocumentResponse//toop:ErrorCode" mode="M33" priority="1000">
...
<xsl:template match="toop:DocumentRequestTypeCode | toop:DocumentTypeCode" mode="M34" priority="1000">
...
<xsl:template match="toop:PreferredDocumentMimeTypeCode | toop:DocumentMimeTypeCode" mode="M35" priority="1000">
...
<xsl:template match="toop:ProcessIdentifier" mode="M36" priority="1000">
...
<xsl:template match="toop:DCElectronicAddressIdentifier | toop:DPElectronicAddressIdentifier" mode="M37" priority="1000">
...
<xsl:template match="toop:Error//toop:Origin" mode="M38" priority="1000">
...
<xsl:template match="toop:Error//toop:Category" mode="M39" priority="1000">
...
<xsl:template match="toop:Error//toop:Severity" mode="M40" priority="1000">
...
<xsl:template match="toop:Error//toop:ErrorCode" mode="M41" priority="1000">
