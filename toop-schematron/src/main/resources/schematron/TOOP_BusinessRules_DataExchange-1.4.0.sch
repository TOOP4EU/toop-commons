...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
    ...
    <pattern>
        <rule context="toop:Request">
            ...
            <assert test="matches(//toop:RoutingInformation//toop:DocumentTypeIdentifier/text(),'urn:eu:toop:ns:dataexchange-1p40::Request##urn:eu.toop.request.registeredorganization::1.40')" flag='ERROR' id="mandatory_req_doc_id">
    ...
    <pattern>
        <rule context="toop:Response">
            ...
            <assert test="matches(toop:RoutingInformation//toop:DocumentTypeIdentifier/text(),'urn:eu:toop:ns:dataexchange-1p40::Response##urn:eu.toop.response.registeredorganization::1.40')" flag='ERROR' id="mandatory_res_doc_id">
