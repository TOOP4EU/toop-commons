...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
    ...
    queryBinding="xslt2" 
    >
    <title>TOOP Business Rules (specs Version 1.2.0)</title>
    ...
    <pattern>
            ...
            <rule context="toop:Error//toop:DataProviderIdentifier" flag='ERROR' id='check_matching_dataprovider_id'> 
                <assert test="$dataproviderids[normalize-space(.) = normalize-space(current()/.)]">The DataProviderID contained in an Error must match the ID of a DataProvider in this message.</assert> 
            </rule> 
    </pattern>
