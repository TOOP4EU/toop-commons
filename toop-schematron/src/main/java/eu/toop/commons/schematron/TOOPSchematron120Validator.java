 ...
 */
@ThreadSafe
public class TOOPSchematron120Validator
{
  /**
   * The resource with the rules. Important: this Schematron requires additional
   * code lists in a relative directory!
   */
  public static final IReadableResource TOOP_120_SCHEMATRON_RES_XSLT = new ClassPathResource ("120/xslt/TOOP_BusinessRules_DataExchange.xslt");

  public TOOPSchematron120Validator ()
  {}
  ...
  {
    final SchematronResourceXSLT aSchematron = new SchematronResourceXSLT (TOOP_120_SCHEMATRON_RES_XSLT);
    if (!aSchematron.isValidSchematron ())
      throw new IllegalStateException ("Failed to compile Schematron/XSLT " + TOOP_120_SCHEMATRON_RES_XSLT.getPath ());
    return aSchematron;
  }
