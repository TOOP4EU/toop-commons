...
public enum EPredefinedProcessIdentifier implements IPredefinedIdentifier
{
  ...
  @Nullable
  public static EPredefinedProcessIdentifier getFromProcessIdentifierOrNull (@Nullable final String sScheme,
